 ...
 * @describe 图书信息实体类
 */
public class BookDouBan implements Parcelable {
	//图书ID
	private String id;
    //图书标题
	 ...
	 * 5.writeToParcel()
	 */
	public static Parcelable.Creator<BookDouBan> getCreator() {
		return CREATOR;
	}
	
	public static void setCreator(Parcelable.Creator<BookDouBan> creator) {
		CREATOR = creator;
	}
	
	public static Parcelable.Creator<BookDouBan> CREATOR = new Creator<BookDouBan>() {
        public BookDouBan createFromParcel(Parcel source) {
            BookDouBan bookInfo = new BookDouBan();
        ...
        public BookDouBan[] newArray(int size) {
            return new BookDouBan[size];
        }
    };
