...
public class BookViewActivity extends Activity {
    ...
    private BookDouBan book;
    //private Book booksDatas;
    @Override
...
//		});  
        ...
        //添加按钮
        btn_add = (Button) findViewById(R.id.bt_bookView_add);
        btn_add.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent2=new Intent(BookViewActivity.this,AddBook.class);
				intent2.putExtra("books_data", book);
				startActivity(intent2);
				finish();
			}
		});
        ...
        intent=getIntent();
        book=(BookDouBan)intent.getParcelableExtra(BookDouBan.class.getName());
        //booksDatas = new Book(book.getTitle(), book.getAuthor(), "西岭", 0, null, false, "科技类");
        //将Book信息显示在控件上
